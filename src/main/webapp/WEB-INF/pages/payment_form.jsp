...
<body>
<form id="payment_form" action="${pageContext.request.contextPath}/postcybersource" method="post">
    <input type="hidden" name="access_key" value="6c8e739ea89334eba35ec08f4226ec27">
    <input type="hidden" name="profile_id" value="5A696BC0-DB15-4629-985F-3470137987F0">
